def githubStatusCheck(String state, String description){
    ...
    githubNotify account: 'inspectorguidget',sha: "${commitHash}", status: state, description: description, credentialsId: 'github-token', repo: 'inspectorguidget-coverage'
}
    ...
    stages {
        ...
        stage ('Git') {
            steps {
                ...
                git branch: 'master', url: "https://github.com/inspectorguidget/inspectorguidget-coverage"
            }
        }
